...
namespace CustomerIncidents.TechSupportDataSetTableAdapters {
...
SELECT CustomerID, Name, Address, City, State, ZipCode, Phone, Email FROM Customers WHERE (CustomerID = @CustomerID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CustomerIncidents.Properties.Settings.Default.TechSupportConnectionString;
        }
...
SELECT IncidentID, CustomerID, ProductCode, DateOpened, DateClosed, Title FROM Incidents WHERE (IncidentID = @IncidentID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT IncidentID, CustomerID, ProductCode, DateOpened, DateClosed, Title \r\nFROM " +
                "Incidents\r\nWHERE (CustomerID = @CustomerID)";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(TechSupportDataSet.IncidentsDataTable dataTable, int CustomerID) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(CustomerID));
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual TechSupportDataSet.IncidentsDataTable GetData(int CustomerID) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(CustomerID));
